/*
	 numu.c
		...
		$Author: niklas $ $Date: 2006/02/01 22:47:59 $ $Revision: 1.2 $
*/
    ...
    y = log10(Tp*0.001);
				...
				*/
				...
				if (Tp > 0.4) {
								...
								a[7] = 2741.82 + 222.01*log10(9.7401e-13*(y + 3.9)) + -4772.5/(y + 19.773) - 6.1001*y*y;
				...
				*/
				...
				if (Tp > 1.38) {
								if (Tp > 11.0) {
												...
												b[1] = -7.6016 + 3042.67675781*exp(-1.0134e4*pow((y + 2.3066)/(1.0 + 41.612*(y + 2.3066)), 2));
